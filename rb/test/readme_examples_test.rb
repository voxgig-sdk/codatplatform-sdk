...
#      offline in seeded test mode (CodatplatformSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Codatplatform_sdk.rb")
  SDK_CLASS = "CodatplatformSDK"
