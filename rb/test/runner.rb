...
module CodatplatformTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("CODATPLATFORM_TEST_LIVE")
    override = getenv("CODATPLATFORM_TEST_OVERRIDE")
    ...
    explain = getenv("CODATPLATFORM_TEST_EXPLAIN")
    m["CODATPLATFORM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CodatplatformTestRunner
Helpers = CodatplatformHelpers
Vs = VoxgigStruct
