# Codatplatform SDK Integration entity
...
class IntegrationEntity
  ...
  # @return [Integration, Hash] the loaded Integration; raises CodatplatformError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Integration>, Array] the matching Integration items; raises CodatplatformError on failure
