...
class PushEntity
  ...
  # @return [Push, Hash] the current Push data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Push fields)
  def match_get
  ...
  # Load a single Push.
  #
  # @param reqmatch [PushLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Push.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Push, Hash] the loaded Push; raises CodatplatformError on failure
  ...
  #
  # @param reqmatch [PushListMatch, Hash, nil] match filter (any subset of
  #   Push fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Push>, Array] the matching Push items; raises CodatplatformError on failure
