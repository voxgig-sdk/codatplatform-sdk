...
class ConnectionManagementAccessTokenEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "connection_management_access_token"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ConnectionManagementAccessTokenEntity.new(@_client, opts)
  end
  ...
  # @return [ConnectionManagementAccessToken, Hash] the current ConnectionManagementAccessToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConnectionManagementAccessToken fields)
  def match_get
  ...
  #
  # @param reqmatch [ConnectionManagementAccessTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ConnectionManagementAccessToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConnectionManagementAccessToken, Hash] the loaded ConnectionManagementAccessToken; raises CodatplatformError on failure
