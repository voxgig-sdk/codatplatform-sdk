...
class PushOptionEntity
  ...
  def make
    opts = @_entopts.dup
    PushOptionEntity.new(@_client, opts)
  end
  ...
  # @return [PushOption, Hash] the current PushOption data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PushOption fields)
  def match_get
  ...
  #
  # @param reqmatch [PushOptionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PushOption.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PushOption, Hash] the loaded PushOption; raises CodatplatformError on failure
