...
class SyncSettingEntity
  ...
  def make
    opts = @_entopts.dup
    SyncSettingEntity.new(@_client, opts)
  end
  ...
  # @return [SyncSetting, Hash] the current SyncSetting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SyncSetting fields)
  def match_get
  ...
  #
  # @param reqmatch [SyncSettingListMatch, Hash, nil] match filter (any subset of
  #   SyncSetting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<SyncSetting>, Array] the matching SyncSetting items; raises CodatplatformError on failure
