...
class ProfileEntity
  ...
  def make
    opts = @_entopts.dup
    ProfileEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ProfileListMatch, Hash, nil] match filter (any subset of
  #   Profile fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Profile>, Array] the matching Profile items; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [ProfileUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Profile, Hash] the updated Profile; raises CodatplatformError on failure
