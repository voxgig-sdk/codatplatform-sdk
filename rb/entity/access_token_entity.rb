...
class AccessTokenEntity
  ...
  def make
    opts = @_entopts.dup
    AccessTokenEntity.new(@_client, opts)
  end
  ...
  # @return [AccessToken, Hash] the current AccessToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccessToken fields)
  def match_get
