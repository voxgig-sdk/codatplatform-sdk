...
class SupplementalDataConfigEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "supplemental_data_config"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    SupplementalDataConfigEntity.new(@_client, opts)
  end
  ...
  # @return [SupplementalDataConfig, Hash] the current SupplementalDataConfig data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SupplementalDataConfig fields)
  def match_get
  ...
  #
  # @param reqmatch [SupplementalDataConfigLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.SupplementalDataConfig.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [SupplementalDataConfig, Hash] the loaded SupplementalDataConfig; raises CodatplatformError on failure
