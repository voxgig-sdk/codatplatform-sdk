...
class WebhookZapierKeyEntity
  ...
  def make
    opts = @_entopts.dup
    WebhookZapierKeyEntity.new(@_client, opts)
  end
  ...
  # @return [WebhookZapierKey, Hash] the current WebhookZapierKey data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WebhookZapierKey fields)
  def match_get
  ...
  #
  # @param reqdata [WebhookZapierKeyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [WebhookZapierKey, Hash] the created WebhookZapierKey; raises CodatplatformError on failure
