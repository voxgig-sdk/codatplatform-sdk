...
class ValidationEntity
  ...
  def make
    opts = @_entopts.dup
    ValidationEntity.new(@_client, opts)
  end
  ...
  # @return [Validation, Hash] the current Validation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Validation fields)
  def match_get
  ...
  #
  # @param reqmatch [ValidationListMatch, Hash, nil] match filter (any subset of
  #   Validation fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Validation>, Array] the matching Validation items; raises CodatplatformError on failure
