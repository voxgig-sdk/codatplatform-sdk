...
class SupplementalDataEntity
  ...
  def make
    opts = @_entopts.dup
    SupplementalDataEntity.new(@_client, opts)
  end
  ...
  # @return [SupplementalData, Hash] the current SupplementalData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SupplementalData fields)
  def match_get
  ...
  #
  # @param reqdata [SupplementalDataUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SupplementalData, Hash] the updated SupplementalData; raises CodatplatformError on failure
