...
class ConnectionEntity
  ...
  #
  # @param reqmatch [ConnectionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Connection.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Connection, Hash] the loaded Connection; raises CodatplatformError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Connection>, Array] the matching Connection items; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [ConnectionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Connection, Hash] the created Connection; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [ConnectionUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Connection, Hash] the updated Connection; raises CodatplatformError on failure
  ...
  #
  # @param reqmatch [ConnectionRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Connection, Hash] the removed Connection; raises CodatplatformError on failure
