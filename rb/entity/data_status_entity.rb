...
class DataStatusEntity
  ...
  def make
    opts = @_entopts.dup
    DataStatusEntity.new(@_client, opts)
  end
  ...
  # @return [DataStatus, Hash] the current DataStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DataStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [DataStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DataStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DataStatus, Hash] the loaded DataStatus; raises CodatplatformError on failure
