...
class RefreshDataEntity
  ...
  def make
    opts = @_entopts.dup
    RefreshDataEntity.new(@_client, opts)
  end
  ...
  # @return [RefreshData, Hash] the current RefreshData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RefreshData fields)
  def match_get
  ...
  #
  # @param reqdata [RefreshDataCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RefreshData, Hash] the created RefreshData; raises CodatplatformError on failure
