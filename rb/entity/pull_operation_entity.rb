...
class PullOperationEntity
  ...
  def make
    opts = @_entopts.dup
    PullOperationEntity.new(@_client, opts)
  end
  ...
  # @return [PullOperation, Hash] the current PullOperation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PullOperation fields)
  def match_get
  ...
  #
  # @param reqmatch [PullOperationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PullOperation.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PullOperation, Hash] the loaded PullOperation; raises CodatplatformError on failure
  ...
  #
  # @param reqmatch [PullOperationListMatch, Hash, nil] match filter (any subset of
  #   PullOperation fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PullOperation>, Array] the matching PullOperation items; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [PullOperationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PullOperation, Hash] the created PullOperation; raises CodatplatformError on failure
