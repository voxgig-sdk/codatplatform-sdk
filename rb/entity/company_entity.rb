...
class CompanyEntity
  ...
  # @return [Company, Hash] the loaded Company; raises CodatplatformError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Company>, Array] the matching Company items; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [CompanyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Company, Hash] the created Company; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [CompanyUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Company, Hash] the updated Company; raises CodatplatformError on failure
  ...
  #
  # @param reqmatch [CompanyRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Company, Hash] the removed Company; raises CodatplatformError on failure
