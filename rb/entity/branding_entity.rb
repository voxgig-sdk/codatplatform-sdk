...
class BrandingEntity
  ...
  def make
    opts = @_entopts.dup
    BrandingEntity.new(@_client, opts)
  end
  ...
  # @return [Branding, Hash] the current Branding data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Branding fields)
  def match_get
  ...
  #
  # @param reqmatch [BrandingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Branding.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Branding, Hash] the loaded Branding; raises CodatplatformError on failure
