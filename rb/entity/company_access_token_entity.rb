...
class CompanyAccessTokenEntity
  ...
  def make
    opts = @_entopts.dup
    CompanyAccessTokenEntity.new(@_client, opts)
  end
  ...
  # @return [CompanyAccessToken, Hash] the current CompanyAccessToken data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CompanyAccessToken fields)
  def match_get
  ...
  #
  # @param reqmatch [CompanyAccessTokenLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CompanyAccessToken.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CompanyAccessToken, Hash] the loaded CompanyAccessToken; raises CodatplatformError on failure
