# Codatplatform SDK Webhook entity
...
class WebhookEntity
  ...
  # @return [Array<Webhook>, Array] the matching Webhook items; raises CodatplatformError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the created Webhook; raises CodatplatformError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the removed Webhook; raises CodatplatformError on failure
