...
class SettingEntity
  ...
  def make
    opts = @_entopts.dup
    SettingEntity.new(@_client, opts)
  end
  ...
  # @return [Setting, Hash] the current Setting data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Setting fields)
  def match_get
  ...
  #
  # @param reqmatch [SettingListMatch, Hash, nil] match filter (any subset of
  #   Setting fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Setting>, Array] the matching Setting items; raises CodatplatformError on failure
  ...
  #
  # @param reqdata [SettingCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Setting, Hash] the created Setting; raises CodatplatformError on failure
  ...
  #
  # @param reqmatch [SettingRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Setting, Hash] the removed Setting; raises CodatplatformError on failure
