# Codatplatform SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CodatplatformSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CodatplatformSDK(...) and CodatplatformSDK.test(...) become
#      CodatplatformSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "codatplatform_sdk"
_SDK_CLASS = "CodatplatformSDK"
...
_ENTITIES = {
    ...
    "Branding": "branding",
    "Company": "company",
    "CompanyAccessToken": "company_access_token",
    "Connection": "connection",
    "ConnectionManagementAccessToken": "connection_management_access_token",
    "ConnectionManagementAllowedOrigin": "connection_management_allowed_origin",
    "Custom": "custom",
    ...
    "Product": "product",
    "Profile": "profile",
    "PullOperation": "pull_operation",
    "Push": "push",
    "PushOption": "push_option",
    "Queue": "queue",
    "RefreshData": "refresh_data",
    "Setting": "setting",
    "SupplementalData": "supplemental_data",
    "SupplementalDataConfig": "supplemental_data_config",
    "Sync": "sync",
    "SyncSetting": "sync_setting",
    "Validation": "validation",
    "Webhook": "webhook",
    "WebhookZapierKey": "webhook_zapier_key",
}
