...
from codatplatform_sdk.core.control import CodatplatformControl
...
from codatplatform_sdk.core.helpers import get_ctx_prop, to_map
...
class CodatplatformContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CodatplatformControl()
        ...
        if isinstance(sp, CodatplatformSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CodatplatformResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CodatplatformResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CodatplatformError(code, msg, self)
