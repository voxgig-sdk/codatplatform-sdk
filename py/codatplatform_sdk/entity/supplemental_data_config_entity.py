...
class SupplementalDataConfigEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SupplementalDataConfigEntity(self._client, opts)
    ...
    def data_get(self) -> SupplementalDataConfig:
    ...
    def match_get(self) -> SupplementalDataConfig:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SupplementalDataConfig:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SupplementalDataConfig().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
