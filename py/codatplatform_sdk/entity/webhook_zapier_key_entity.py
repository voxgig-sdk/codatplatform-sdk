...
class WebhookZapierKeyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhookZapierKeyEntity(self._client, opts)
    ...
    def data_get(self) -> WebhookZapierKey:
    ...
    def match_get(self) -> WebhookZapierKey:
    ...
    def create(self, reqdata: WebhookZapierKeyCreateData, ctrl=None) -> WebhookZapierKey:
        utility = self._utility
