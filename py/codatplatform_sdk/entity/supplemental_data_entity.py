...
class SupplementalDataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SupplementalDataEntity(self._client, opts)
    ...
    def data_get(self) -> SupplementalData:
    ...
    def match_get(self) -> SupplementalData:
    ...
    def update(self, reqdata: SupplementalDataUpdateData, ctrl=None) -> SupplementalData:
        utility = self._utility
