...
class CompanyAccessTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanyAccessTokenEntity(self._client, opts)
    ...
    def data_get(self) -> CompanyAccessToken:
    ...
    def match_get(self) -> CompanyAccessToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CompanyAccessToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CompanyAccessToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
