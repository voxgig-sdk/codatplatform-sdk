...
class ConnectionManagementAccessTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConnectionManagementAccessTokenEntity(self._client, opts)
    ...
    def data_get(self) -> ConnectionManagementAccessToken:
    ...
    def match_get(self) -> ConnectionManagementAccessToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConnectionManagementAccessToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConnectionManagementAccessToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
