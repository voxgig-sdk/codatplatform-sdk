...
class RefreshDataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RefreshDataEntity(self._client, opts)
    ...
    def match_get(self) -> RefreshData:
    ...
    def create(self, reqdata: RefreshDataCreateData, ctrl=None) -> RefreshData:
        utility = self._utility
