...
class SettingEntity extends CodatplatformEntityBase<Setting> {
  ...
  make(this: SettingEntity) {
    return new SettingEntity(this._client, this.entopts())
  }




  async list(this: any, reqmatch?: SettingListMatch, ctrl?: Control): Promise<SettingEntity[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Setting[]> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: SettingCreateData, ctrl?: Control): Promise<SettingEntity> {
  ...
  async remove(
    this: any, reqmatch?: SettingRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SettingEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
