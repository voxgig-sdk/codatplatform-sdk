...
import type {
  ...
  ConnectionRemoveMatch,
} from '../CodatplatformTypes'

// TODO: needs Entity superclass
class ConnectionEntity extends CodatplatformEntityBase<Connection> {
  ...
  async load(this: any, reqmatch?: ConnectionLoadMatch, ctrl?: Control): Promise<ConnectionEntity> {
  ...
  async create(this: any, reqdata?: ConnectionCreateData, ctrl?: Control): Promise<ConnectionEntity> {
  ...
  async update(this: any, reqdata?: ConnectionUpdateData, ctrl?: Control): Promise<ConnectionEntity> {
  ...
  async remove(
    this: any, reqmatch?: ConnectionRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ConnectionEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
