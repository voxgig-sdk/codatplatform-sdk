...
class CodatplatformSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('CodatplatformSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Branding(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  CompanyAccessToken(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ConnectionManagementAccessToken(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ConnectionManagementAllowedOrigin(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  DataStatus(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  PullOperation(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  PushOption(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  RefreshData(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SupplementalData(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SyncSetting(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Validation(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  WebhookZapierKey(entopts?: Record<string, any>) {
    const self = this
