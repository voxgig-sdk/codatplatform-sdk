...
class SyncSettingEntity extends CodatplatformEntityBase_1.CodatplatformEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'sync_setting';
        this.name_ = 'sync_setting';
        this.Name = 'SyncSetting';
    }
    make() {
        return new SyncSettingEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<SyncSetting[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.SyncSettingEntity = SyncSettingEntity;
//# sourceMappingURL=SyncSettingEntity.js.map