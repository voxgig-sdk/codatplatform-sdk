...
(0, node_test_1.describe)('ConnectionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(connection_ref01_resdata_up0.id === connection_ref01_data_up0.id);
        (0, node_assert_1.default)(connection_ref01_resdata_up0[connection_ref01_markdef_up0.name] === connection_ref01_markdef_up0.value);
        // LOAD
...
function basicSetup(extra) {
    ...
    let idmap = transform(['connection01', 'connection02', 'connection03', 'company01', 'company02', 'company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
