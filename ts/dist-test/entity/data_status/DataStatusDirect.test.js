...
(0, node_test_1.describe)('DataStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-data_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-data_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_DATA_STATUS_ENTID'];
...
//# sourceMappingURL=DataStatusDirect.test.js.map