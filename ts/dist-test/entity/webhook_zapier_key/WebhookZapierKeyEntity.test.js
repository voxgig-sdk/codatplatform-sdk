...
(0, node_test_1.describe)('WebhookZapierKeyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'webhook_zapier_key.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != webhook_zapier_key_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/webhook_zapier_key/WebhookZapierKeyTestData.json');
    ...
    let idmap = transform(['webhook_zapier_key01', 'webhook_zapier_key02', 'webhook_zapier_key03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=WebhookZapierKeyEntity.test.js.map