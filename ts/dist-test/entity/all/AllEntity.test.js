...
(0, node_test_1.describe)('AllEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "all", "op": {}, "relations": { "ancestors": [["company"]] }, "key$": "all", "name__orig": "all", "Name": "All", "name_": "all", "name-": "all", "NAME": "ALL", "index$": 1 }, { "active": true, "entity": "all", "key$": "BasicAllFlow", "kind": "basic", "name": "BasicAllFlow", "param": {}, "step": [] }, 'All');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['all01', 'all02', 'all03', 'company01', 'company02', 'company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
