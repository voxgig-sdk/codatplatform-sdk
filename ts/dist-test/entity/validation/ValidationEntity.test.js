...
(0, node_test_1.describe)('ValidationEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/validation/ValidationTestData.json');
    ...
    let idmap = transform(['validation01', 'validation02', 'validation03', 'company01', 'company02', 'company03', 'sync01', 'sync02', 'sync03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_VALIDATION_ENTID'];
...
//# sourceMappingURL=ValidationEntity.test.js.map