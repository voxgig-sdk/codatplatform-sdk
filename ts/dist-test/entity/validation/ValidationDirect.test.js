...
(0, node_test_1.describe)('ValidationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-validation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-validation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["company01", "sync01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_VALIDATION_ENTID'];
...
//# sourceMappingURL=ValidationDirect.test.js.map