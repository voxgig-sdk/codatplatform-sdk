...
(0, node_test_1.describe)('BrandingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'branding.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/branding/BrandingTestData.json');
    ...
    let idmap = transform(['branding01', 'branding02', 'branding03', 'integration01', 'integration02', 'integration03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_BRANDING_ENTID'];
...
//# sourceMappingURL=BrandingEntity.test.js.map