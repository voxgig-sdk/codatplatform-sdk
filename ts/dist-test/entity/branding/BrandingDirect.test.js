...
(0, node_test_1.describe)('BrandingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-branding', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-branding', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_BRANDING_ENTID'];
...
//# sourceMappingURL=BrandingDirect.test.js.map