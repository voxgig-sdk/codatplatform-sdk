...
(0, node_test_1.describe)('RefreshDataEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.RefreshData();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.CODATPLATFORM_TEST_LIVE;
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'refresh_data.' + op, live))
                return;
        }
        ...
        // CREATE
        const refresh_data_ref01_ent = client.RefreshData();
        ...
        (0, node_assert_1.default)(null != refresh_data_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/refresh_data/RefreshDataTestData.json');
    ...
    let idmap = transform(['refresh_data01', 'refresh_data02', 'refresh_data03', 'company01', 'company02', 'company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_REFRESH_DATA_ENTID'];
    ...
    idmap = env['CODATPLATFORM_TEST_REFRESH_DATA_ENTID'];
...
//# sourceMappingURL=RefreshDataEntity.test.js.map