...
(0, node_test_1.describe)('PullOperationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'pull_operation.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != pull_operation_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(pull_operation_ref01_list, { id: pull_operation_ref01_data.id })));
        // LOAD
        ...
        (0, node_assert_1.default)(pull_operation_ref01_data_dt0.id === pull_operation_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/pull_operation/PullOperationTestData.json');
    ...
    let idmap = transform(['pull_operation01', 'pull_operation02', 'pull_operation03', 'company01', 'company02', 'company03', 'company01', 'company02', 'company03', 'history01', 'history02', 'history03', 'company01', 'company02', 'company03', 'queue01', 'queue02', 'queue03', 'company01', 'company02', 'company03', 'connection01', 'connection02', 'connection03', 'custom01', 'custom02', 'custom03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PullOperationEntity.test.js.map