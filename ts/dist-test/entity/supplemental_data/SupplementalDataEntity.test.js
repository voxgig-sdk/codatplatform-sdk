...
(0, node_test_1.describe)('SupplementalDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'supplemental_data.' + op, live))
                return;
        }
        ...
        let supplemental_data_ref01_data = Object.values(setup.data.existing.supplemental_data)[0];
        // UPDATE
        const supplemental_data_ref01_ent = client.SupplementalData();
        const supplemental_data_ref01_data_up0 = {};
        ...
        (0, node_assert_1.default)(null != supplemental_data_ref01_resdata_up0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/supplemental_data/SupplementalDataTestData.json');
    ...
    let idmap = transform(['supplemental_data01', 'supplemental_data02', 'supplemental_data03', 'integration01', 'integration02', 'integration03', 'data_type01', 'data_type02', 'data_type03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_SUPPLEMENTAL_DATA_ENTID'];
...
//# sourceMappingURL=SupplementalDataEntity.test.js.map