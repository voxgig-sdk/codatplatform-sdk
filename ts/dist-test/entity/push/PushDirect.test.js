...
(0, node_test_1.describe)('PushDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-push', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-push', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-push', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-push', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["company01"]))
            return;
        const { client, calls } = setup;
...
//# sourceMappingURL=PushDirect.test.js.map