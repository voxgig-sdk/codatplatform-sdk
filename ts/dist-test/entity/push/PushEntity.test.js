...
(0, node_test_1.describe)('PushEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'push.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/push/PushTestData.json');
    ...
    let idmap = transform(['push01', 'push02', 'push03', 'company01', 'company02', 'company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_PUSH_ENTID'];
...
//# sourceMappingURL=PushEntity.test.js.map