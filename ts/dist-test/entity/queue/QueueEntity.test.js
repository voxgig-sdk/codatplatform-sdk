...
(0, node_test_1.describe)('QueueEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'queue.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "queue", "op": {}, "relations": { "ancestors": [["company"]] }, "key$": "queue", "name__orig": "queue", "Name": "Queue", "name_": "queue", "name-": "queue", "NAME": "QUEUE", "index$": 20 }, { "active": true, "entity": "queue", "key$": "BasicQueueFlow", "kind": "basic", "name": "BasicQueueFlow", "param": {}, "step": [] }, 'Queue');
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/queue/QueueTestData.json');
    ...
    let idmap = transform(['queue01', 'queue02', 'queue03', 'company01', 'company02', 'company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=QueueEntity.test.js.map