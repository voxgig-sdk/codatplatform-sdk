...
(0, node_test_1.describe)('PushOptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-push_option', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-push_option', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_PUSH_OPTION_ENTID'];
...
//# sourceMappingURL=PushOptionDirect.test.js.map