...
(0, node_test_1.describe)('PushOptionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'push_option.' + op, live))
                return;
        }
        ...
        let push_option_ref01_data = Object.values(setup.data.existing.push_option)[0];
        // LOAD
        ...
        (0, node_assert_1.default)(push_option_ref01_data_dt0.id === push_option_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/push_option/PushOptionTestData.json');
    ...
    let idmap = transform(['push_option01', 'push_option02', 'push_option03', 'company01', 'company02', 'company03', 'connection01', 'connection02', 'connection03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_PUSH_OPTION_ENTID'];
...
//# sourceMappingURL=PushOptionEntity.test.js.map