...
(0, node_test_1.describe)('ProfileDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-profile', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-profile', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_PROFILE_ENTID'];
...
//# sourceMappingURL=ProfileDirect.test.js.map