...
(0, node_test_1.describe)('CompanyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != company_ref01_data.id);
        // LIST
        const company_ref01_match = {};
        const company_ref01_list = (await company_ref01_ent.list(company_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(company_ref01_list, { id: company_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(company_ref01_resdata_up0.id === company_ref01_data_up0.id);
        (0, node_assert_1.default)(company_ref01_resdata_up0[company_ref01_markdef_up0.name] === company_ref01_markdef_up0.value);
        // LOAD
        ...
        // REMOVE
        const company_ref01_match_rm0 = { id: company_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(company_ref01_list_rt0, { id: company_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['company01', 'company02', 'company03', 'product01', 'product02', 'product03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
