...
(0, node_test_1.describe)('OptionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "option", "op": {}, "relations": { "ancestors": [["company", "connection"]] }, "key$": "option", "name__orig": "option", "Name": "Option", "name_": "option", "name-": "option", "NAME": "OPTION", "index$": 14 }, { "active": true, "entity": "option", "key$": "BasicOptionFlow", "kind": "basic", "name": "BasicOptionFlow", "param": {}, "step": [] }, 'Option');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['option01', 'option02', 'option03', 'company01', 'company02', 'company03', 'connection01', 'connection02', 'connection03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        const rawIds = process.env['CODATPLATFORM_TEST_OPTION_ENTID'];
