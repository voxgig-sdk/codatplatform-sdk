...
(0, node_test_1.describe)('ConnectionManagementAccessTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'connection_management_access_token.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/connection_management_access_token/ConnectionManagementAccessTokenTestData.json');
    ...
    let idmap = transform(['connection_management_access_token01', 'connection_management_access_token02', 'connection_management_access_token03', 'company01', 'company02', 'company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_CONNECTION_MANAGEMENT_ACCESS_TOKEN_ENTID'];
...
//# sourceMappingURL=ConnectionManagementAccessTokenEntity.test.js.map