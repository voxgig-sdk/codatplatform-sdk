...
(0, node_test_1.describe)('CompanyAccessTokenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-company_access_token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-company_access_token', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CODATPLATFORM_TEST_COMPANY_ACCESS_TOKEN_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_COMPANY_ACCESS_TOKEN_ENTID'];
...
//# sourceMappingURL=CompanyAccessTokenDirect.test.js.map