...
(0, node_test_1.describe)('CompanyAccessTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'company_access_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(company_access_token_ref01_data_dt0.id === company_access_token_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/company_access_token/CompanyAccessTokenTestData.json');
    ...
    let idmap = transform(['company_access_token01', 'company_access_token02', 'company_access_token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_COMPANY_ACCESS_TOKEN_ENTID'];
...
//# sourceMappingURL=CompanyAccessTokenEntity.test.js.map