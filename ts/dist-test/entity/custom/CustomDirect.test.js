...
(0, node_test_1.describe)('CustomDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom', setup.live))
            return;
...
//# sourceMappingURL=CustomDirect.test.js.map