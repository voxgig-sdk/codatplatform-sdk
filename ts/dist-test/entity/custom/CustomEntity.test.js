...
(0, node_test_1.describe)('CustomEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'custom.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['custom01', 'custom02', 'custom03', 'integration01', 'integration02', 'integration03', 'company01', 'company02', 'company03', 'connection01', 'connection02', 'connection03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_CUSTOM_ENTID'];
