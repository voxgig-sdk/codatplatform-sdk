...
(0, node_test_1.describe)('SettingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-setting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-setting', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_SETTING_ENTID'];
...
//# sourceMappingURL=SettingDirect.test.js.map