...
(0, node_test_1.describe)('SupplementalDataConfigEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'supplemental_data_config.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['supplemental_data_config01', 'supplemental_data_config02', 'supplemental_data_config03', 'integration01', 'integration02', 'integration03', 'data_type01', 'data_type02', 'data_type03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
