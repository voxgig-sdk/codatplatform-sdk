...
(0, node_test_1.describe)('SupplementalDataConfigDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-supplemental_data_config', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-supplemental_data_config', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_SUPPLEMENTAL_DATA_CONFIG_ENTID'];
...
//# sourceMappingURL=SupplementalDataConfigDirect.test.js.map