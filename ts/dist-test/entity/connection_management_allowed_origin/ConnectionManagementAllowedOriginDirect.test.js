...
(0, node_test_1.describe)('ConnectionManagementAllowedOriginDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-connection_management_allowed_origin', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-connection_management_allowed_origin', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CODATPLATFORM_TEST_CONNECTION_MANAGEMENT_ALLOWED_ORIGIN_ENTID'];
...
//# sourceMappingURL=ConnectionManagementAllowedOriginDirect.test.js.map