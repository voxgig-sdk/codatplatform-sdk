...
(0, node_test_1.describe)('ConnectionManagementAllowedOriginEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'connection_management_allowed_origin.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['CODATPLATFORM_TEST_CONNECTION_MANAGEMENT_ALLOWED_ORIGIN_ENTID'];
