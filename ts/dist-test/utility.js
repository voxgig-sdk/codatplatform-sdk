...
function envOverride(m) {
    if ('TRUE' === process.env.CODATPLATFORM_TEST_LIVE ||
        'TRUE' === process.env.CODATPLATFORM_TEST_OVERRIDE) {
    ...
    m.CODATPLATFORM_TEST_EXPLAIN = process.env.CODATPLATFORM_TEST_EXPLAIN || m.CODATPLATFORM_TEST_EXPLAIN;
    return m;
}
