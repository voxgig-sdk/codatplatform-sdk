...
const __1 = require("..");
const SDK_NAME = 'CodatplatformSDK';
...
const TEST_SEED = { "entity": { "access_token": { "test01": { "id": "test01" } }, "all": { "test01": { "id": "test01" } }, "api_key": { "test01": { "id": "test01" } }, "branding": { "test01": { "id": "test01" } }, "company": { "test01": { "id": "test01" } }, "company_access_token": { "test01": { "id": "test01" } }, "connection": { "test01": { "id": "test01" } }, "connection_management_access_token": { "test01": { "id": "test01" } }, "connection_management_allowed_origin": { "test01": { "id": "test01" } }, "custom": { "test01": { "id": "test01" } }, "data_status": { "test01": { "id": "test01" } }, "data_type": { "test01": { "id": "test01" } }, "history": { "test01": { "id": "test01" } }, "integration": { "test01": { "id": "test01" } }, "option": { "test01": { "id": "test01" } }, "product": { "test01": { "id": "test01" } }, "profile": { "test01": { "id": "test01" } }, "pull_operation": { "test01": { "id": "test01" } }, "push": { "test01": { "id": "test01" } }, "push_option": { "test01": { "id": "test01" } }, "queue": { "test01": { "id": "test01" } }, "refresh_data": { "test01": { "id": "test01" } }, "setting": { "test01": { "id": "test01" } }, "supplemental_data": { "test01": { "id": "test01" } }, "supplemental_data_config": { "test01": { "id": "test01" } }, "sync": { "test01": { "id": "test01" } }, "sync_setting": { "test01": { "id": "test01" } }, "validation": { "test01": { "id": "test01" } }, "webhook": { "test01": { "id": "test01" } }, "webhook_zapier_key": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+CodatplatformSDK\b/.test(code) ||
        /\bCodatplatformSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+CodatplatformSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/CodatplatformSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
