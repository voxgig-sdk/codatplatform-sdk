...
describe('ConnectionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    // UPDATE
    const connection_ref01_data_up0: any = {}
    ...
    ;(connection_ref01_data_up0 as any)[connection_ref01_markdef_up0.name] = connection_ref01_markdef_up0.value
    ...
    assert((connection_ref01_resdata_up0 as any)[connection_ref01_markdef_up0.name] === connection_ref01_markdef_up0.value)


    // LOAD
    const connection_ref01_match_dt0: any = {}
    ...
    // REMOVE
    const connection_ref01_match_rm0: any = { id: connection_ref01_data.id }
    await connection_ref01_ent.remove(connection_ref01_match_rm0)
  

    // LIST
    const connection_ref01_match_rt0: any = {}
    connection_ref01_match_rt0['company_id'] = setup.idmap['company01']

    const connection_ref01_list_rt0 = (await connection_ref01_ent.list(connection_ref01_match_rt0)).map((e: any) => e.data())
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['CODATPLATFORM_TEST_CONNECTION_ENTID']
