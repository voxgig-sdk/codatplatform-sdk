...
describe('ConnectionManagementAccessTokenEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (maybeSkipControl(t, 'entityOp', 'connection_management_access_token.' + op, live)) return
    }
    ...
    let connection_management_access_token_ref01_data = Object.values(setup.data.existing.connection_management_access_token)[0] as any
