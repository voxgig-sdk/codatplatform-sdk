...
function runner.env_override(m)
  local live = runner.getenv("CODATPLATFORM_TEST_LIVE")
  local override = runner.getenv("CODATPLATFORM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CODATPLATFORM_TEST_EXPLAIN")
