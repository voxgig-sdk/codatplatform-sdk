...
describe("PushOptionDirect", function()
  it("should direct-load-push_option", function()
    local setup = push_option_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-push_option", setup.live and "live" or "unit")
...
function push_option_direct_setup(mockres)
