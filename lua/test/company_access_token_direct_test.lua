...
describe("CompanyAccessTokenDirect", function()
  it("should direct-load-company_access_token", function()
    local setup = company_access_token_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-company_access_token", setup.live and "live" or "unit")
...
function company_access_token_direct_setup(mockres)
