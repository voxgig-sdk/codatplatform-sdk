...
describe("DataStatusDirect", function()
  it("should direct-load-data_status", function()
    local setup = data_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data_status", setup.live and "live" or "unit")
...
function data_status_direct_setup(mockres)
