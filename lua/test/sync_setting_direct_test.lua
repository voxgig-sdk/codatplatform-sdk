...
describe("SyncSettingDirect", function()
  it("should direct-list-sync_setting", function()
    local setup = sync_setting_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-sync_setting", setup.live and "live" or "unit")
...
function sync_setting_direct_setup(mockres)
