...
describe("ConnectionManagementAllowedOriginDirect", function()
  it("should direct-list-connection_management_allowed_origin", function()
    local setup = connection_management_allowed_origin_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-connection_management_allowed_origin", setup.live and "live" or "unit")
...
function connection_management_allowed_origin_direct_setup(mockres)
