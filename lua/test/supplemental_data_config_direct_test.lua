...
describe("SupplementalDataConfigDirect", function()
  it("should direct-load-supplemental_data_config", function()
    local setup = supplemental_data_config_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-supplemental_data_config", setup.live and "live" or "unit")
