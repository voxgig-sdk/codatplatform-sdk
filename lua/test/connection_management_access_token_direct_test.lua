...
describe("ConnectionManagementAccessTokenDirect", function()
  it("should direct-load-connection_management_access_token", function()
    local setup = connection_management_access_token_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-connection_management_access_token", setup.live and "live" or "unit")
