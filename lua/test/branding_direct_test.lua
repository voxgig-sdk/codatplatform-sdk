...
describe("BrandingDirect", function()
  it("should direct-load-branding", function()
    local setup = branding_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-branding", setup.live and "live" or "unit")
