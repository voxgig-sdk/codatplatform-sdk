...
describe("SettingDirect", function()
  it("should direct-list-setting", function()
    local setup = setting_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-setting", setup.live and "live" or "unit")
...
function setting_direct_setup(mockres)
