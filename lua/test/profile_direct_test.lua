...
describe("ProfileDirect", function()
  it("should direct-list-profile", function()
    local setup = profile_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-profile", setup.live and "live" or "unit")
...
function profile_direct_setup(mockres)
