...
local SupplementalDataConfigEntity = {}
SupplementalDataConfigEntity.__index = SupplementalDataConfigEntity


function SupplementalDataConfigEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SupplementalDataConfigEntity)
  self._name = "supplemental_data_config"
  self._client = client
...
function SupplementalDataConfigEntity:get_name()
  return self._name
end


function SupplementalDataConfigEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SupplementalDataConfigEntity.new(self._client, opts)
end
...
function SupplementalDataConfigEntity:mark_deleted()
  self._deleted = true
end


function SupplementalDataConfigEntity:deleted()
  return true == self._deleted
end


function SupplementalDataConfigEntity:data_set(args)
  if args ~= nil then
...
function SupplementalDataConfigEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SupplementalDataConfigEntity:match_set(args)
  if args ~= nil then
...
function SupplementalDataConfigEntity:match_get()
...
function SupplementalDataConfigEntity:stream(action, args, callopts)
...
---@param reqmatch SupplementalDataConfigLoadMatch
---@param ctrl? table
---@return SupplementalDataConfig
---@return string? err
function SupplementalDataConfigEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SupplementalDataConfigEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SupplementalDataConfigEntity
