...
local PullOperationEntity = {}
PullOperationEntity.__index = PullOperationEntity


function PullOperationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PullOperationEntity)
  self._name = "pull_operation"
  self._client = client
...
function PullOperationEntity:get_name()
  return self._name
end


function PullOperationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PullOperationEntity.new(self._client, opts)
end
...
function PullOperationEntity:mark_deleted()
  self._deleted = true
end


function PullOperationEntity:deleted()
  return true == self._deleted
end


function PullOperationEntity:data_set(args)
  if args ~= nil then
...
function PullOperationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PullOperationEntity:match_set(args)
  if args ~= nil then
...
function PullOperationEntity:match_get()
...
function PullOperationEntity:stream(action, args, callopts)
...
---@param reqmatch PullOperationLoadMatch
---@param ctrl? table
---@return PullOperation
---@return string? err
function PullOperationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PullOperationListMatch
---@param ctrl? table
---@return PullOperation[]
---@return string? err
function PullOperationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PullOperationCreateData
---@param ctrl? table
---@return PullOperation
---@return string? err
function PullOperationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function PullOperationEntity:_run_op(ctx, post_done)
  local utility = self._utility
