...
local SupplementalDataEntity = {}
SupplementalDataEntity.__index = SupplementalDataEntity


function SupplementalDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SupplementalDataEntity)
  self._name = "supplemental_data"
  self._client = client
...
function SupplementalDataEntity:get_name()
  return self._name
end


function SupplementalDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SupplementalDataEntity.new(self._client, opts)
end
...
function SupplementalDataEntity:mark_deleted()
  self._deleted = true
end


function SupplementalDataEntity:deleted()
  return true == self._deleted
end


function SupplementalDataEntity:data_set(args)
  if args ~= nil then
...
function SupplementalDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SupplementalDataEntity:match_set(args)
  if args ~= nil then
...
function SupplementalDataEntity:match_get()
...
function SupplementalDataEntity:stream(action, args, callopts)
...
---@param reqdata SupplementalDataUpdateData
---@param ctrl? table
---@return SupplementalData
---@return string? err
function SupplementalDataEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function SupplementalDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
