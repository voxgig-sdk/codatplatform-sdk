...
local WebhookZapierKeyEntity = {}
WebhookZapierKeyEntity.__index = WebhookZapierKeyEntity


function WebhookZapierKeyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhookZapierKeyEntity)
  self._name = "webhook_zapier_key"
  self._client = client
...
function WebhookZapierKeyEntity:get_name()
  return self._name
end


function WebhookZapierKeyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhookZapierKeyEntity.new(self._client, opts)
end
...
function WebhookZapierKeyEntity:mark_deleted()
  self._deleted = true
end


function WebhookZapierKeyEntity:deleted()
  return true == self._deleted
end


function WebhookZapierKeyEntity:data_set(args)
  if args ~= nil then
...
function WebhookZapierKeyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhookZapierKeyEntity:match_set(args)
  if args ~= nil then
...
function WebhookZapierKeyEntity:match_get()
...
function WebhookZapierKeyEntity:stream(action, args, callopts)
...
---@param reqdata WebhookZapierKeyCreateData
---@param ctrl? table
---@return WebhookZapierKey
---@return string? err
function WebhookZapierKeyEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function WebhookZapierKeyEntity:_run_op(ctx, post_done)
  local utility = self._utility
