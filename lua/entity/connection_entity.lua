...
---@param reqmatch ConnectionLoadMatch
---@param ctrl? table
---@return Connection
---@return string? err
function ConnectionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConnectionCreateData
---@param ctrl? table
---@return Connection
---@return string? err
function ConnectionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ConnectionUpdateData
---@param ctrl? table
---@return Connection
---@return string? err
function ConnectionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ConnectionRemoveMatch
---@param ctrl? table
---@return Connection
---@return string? err
function ConnectionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
