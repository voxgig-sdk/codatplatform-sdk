...
local DataStatusEntity = {}
DataStatusEntity.__index = DataStatusEntity


function DataStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DataStatusEntity)
  self._name = "data_status"
  self._client = client
...
function DataStatusEntity:get_name()
  return self._name
end


function DataStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DataStatusEntity.new(self._client, opts)
end
...
function DataStatusEntity:mark_deleted()
  self._deleted = true
end


function DataStatusEntity:deleted()
  return true == self._deleted
end


function DataStatusEntity:data_set(args)
  if args ~= nil then
...
function DataStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DataStatusEntity:match_set(args)
  if args ~= nil then
...
function DataStatusEntity:match_get()
...
function DataStatusEntity:stream(action, args, callopts)
...
---@param reqmatch DataStatusLoadMatch
---@param ctrl? table
---@return DataStatus
---@return string? err
function DataStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DataStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
