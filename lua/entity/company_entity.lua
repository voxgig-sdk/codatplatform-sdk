...
---@param reqdata CompanyCreateData
---@param ctrl? table
---@return Company
---@return string? err
function CompanyEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CompanyUpdateData
---@param ctrl? table
---@return Company
---@return string? err
function CompanyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CompanyRemoveMatch
---@param ctrl? table
---@return Company
---@return string? err
function CompanyEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
