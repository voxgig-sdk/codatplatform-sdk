...
local ConnectionManagementAllowedOriginEntity = {}
ConnectionManagementAllowedOriginEntity.__index = ConnectionManagementAllowedOriginEntity


function ConnectionManagementAllowedOriginEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectionManagementAllowedOriginEntity)
  self._name = "connection_management_allowed_origin"
  self._client = client
...
function ConnectionManagementAllowedOriginEntity:get_name()
  return self._name
end


function ConnectionManagementAllowedOriginEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectionManagementAllowedOriginEntity.new(self._client, opts)
end
...
function ConnectionManagementAllowedOriginEntity:mark_deleted()
  self._deleted = true
end


function ConnectionManagementAllowedOriginEntity:deleted()
  return true == self._deleted
end


function ConnectionManagementAllowedOriginEntity:data_set(args)
  if args ~= nil then
...
function ConnectionManagementAllowedOriginEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectionManagementAllowedOriginEntity:match_set(args)
  if args ~= nil then
...
function ConnectionManagementAllowedOriginEntity:match_get()
...
function ConnectionManagementAllowedOriginEntity:stream(action, args, callopts)
...
---@param reqmatch ConnectionManagementAllowedOriginListMatch
---@param ctrl? table
---@return ConnectionManagementAllowedOrigin[]
---@return string? err
function ConnectionManagementAllowedOriginEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConnectionManagementAllowedOriginCreateData
---@param ctrl? table
---@return ConnectionManagementAllowedOrigin
---@return string? err
function ConnectionManagementAllowedOriginEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ConnectionManagementAllowedOriginEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConnectionManagementAllowedOriginEntity
