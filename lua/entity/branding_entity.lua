...
local BrandingEntity = {}
BrandingEntity.__index = BrandingEntity


function BrandingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BrandingEntity)
  self._name = "branding"
  self._client = client
...
function BrandingEntity:get_name()
  return self._name
end


function BrandingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BrandingEntity.new(self._client, opts)
end
...
function BrandingEntity:mark_deleted()
  self._deleted = true
end


function BrandingEntity:deleted()
  return true == self._deleted
end


function BrandingEntity:data_set(args)
  if args ~= nil then
...
function BrandingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BrandingEntity:match_set(args)
  if args ~= nil then
...
function BrandingEntity:match_get()
...
function BrandingEntity:stream(action, args, callopts)
...
---@param reqmatch BrandingLoadMatch
---@param ctrl? table
---@return Branding
---@return string? err
function BrandingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BrandingEntity:_run_op(ctx, post_done)
  local utility = self._utility
