...
local PushOptionEntity = {}
PushOptionEntity.__index = PushOptionEntity


function PushOptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PushOptionEntity)
  self._name = "push_option"
  self._client = client
...
function PushOptionEntity:get_name()
  return self._name
end


function PushOptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PushOptionEntity.new(self._client, opts)
end
...
function PushOptionEntity:mark_deleted()
  self._deleted = true
end


function PushOptionEntity:deleted()
  return true == self._deleted
end


function PushOptionEntity:data_set(args)
  if args ~= nil then
...
function PushOptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PushOptionEntity:match_set(args)
  if args ~= nil then
...
function PushOptionEntity:match_get()
...
function PushOptionEntity:stream(action, args, callopts)
...
---@param reqmatch PushOptionLoadMatch
---@param ctrl? table
---@return PushOption
---@return string? err
function PushOptionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PushOptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
