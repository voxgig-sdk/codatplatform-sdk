...
func NewSyncSettingEntity(client *core.CodatplatformSDK, entopts map[string]any) *SyncSettingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SyncSettingEntity) GetName() string { return e.name }
...
func (e *SyncSettingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SyncSettingEntity) Deleted() bool {
	return e.deleted
}


func (e *SyncSettingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSyncSettingEntity(e.client, opts)
}

func (e *SyncSettingEntity) Data(args ...any) any {
...
func (e *SyncSettingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SyncSetting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SyncSettingEntity) DataTyped(data ...SyncSetting) SyncSetting {
	if len(data) > 0 {
		return typedFrom[SyncSetting](e.Data(asMap(data[0])))
	}
	return typedFrom[SyncSetting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SyncSetting (all fields
// optional at the wire level).
func (e *SyncSettingEntity) MatchTyped(match ...SyncSetting) SyncSetting {
	if len(match) > 0 {
		return typedFrom[SyncSetting](e.Match(asMap(match[0])))
	}
	return typedFrom[SyncSetting](e.Match())
}
...
func (e *SyncSettingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SyncSettingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SyncSettingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SyncSettingListMatch and returns []SyncSetting. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SyncSettingEntity) ListTyped(reqmatch SyncSettingListMatch, ctrl map[string]any) ([]SyncSetting, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SyncSetting](res), nil
}



func (e *SyncSettingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SyncSettingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SyncSettingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SyncSettingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
