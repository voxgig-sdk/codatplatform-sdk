...
func NewCompanyEntity(client *core.CodatplatformSDK, entopts map[string]any) *CompanyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompanyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CompanyCreateData and returns an Company. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CompanyEntity) CreateTyped(reqdata CompanyCreateData, ctrl map[string]any) (Company, error) {
...
func (e *CompanyEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CompanyUpdateData and returns an Company. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CompanyEntity) UpdateTyped(reqdata CompanyUpdateData, ctrl map[string]any) (Company, error) {
...
func (e *CompanyEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CompanyRemoveMatch and returns an Company. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CompanyEntity) RemoveTyped(reqmatch CompanyRemoveMatch, ctrl map[string]any) (Company, error) {
