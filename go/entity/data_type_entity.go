...
func NewDataTypeEntity(client *core.CodatplatformSDK, entopts map[string]any) *DataTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataTypeEntity) GetName() string { return e.name }
...
func (e *DataTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *DataTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataTypeEntity(e.client, opts)
}

func (e *DataTypeEntity) Data(args ...any) any {
...
func (e *DataTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataTypeEntity) DataTyped(data ...DataType) DataType {
	if len(data) > 0 {
		return typedFrom[DataType](e.Data(asMap(data[0])))
	}
	return typedFrom[DataType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataType (all fields
// optional at the wire level).
func (e *DataTypeEntity) MatchTyped(match ...DataType) DataType {
	if len(match) > 0 {
		return typedFrom[DataType](e.Match(asMap(match[0])))
	}
	return typedFrom[DataType](e.Match())
}
...
func (e *DataTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DataTypeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DataTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
