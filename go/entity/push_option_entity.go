...
func NewPushOptionEntity(client *core.CodatplatformSDK, entopts map[string]any) *PushOptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PushOptionEntity) GetName() string { return e.name }
...
func (e *PushOptionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PushOptionEntity) Deleted() bool {
	return e.deleted
}


func (e *PushOptionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPushOptionEntity(e.client, opts)
}

func (e *PushOptionEntity) Data(args ...any) any {
...
func (e *PushOptionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PushOption; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PushOptionEntity) DataTyped(data ...PushOption) PushOption {
	if len(data) > 0 {
		return typedFrom[PushOption](e.Data(asMap(data[0])))
	}
	return typedFrom[PushOption](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PushOption (all fields
// optional at the wire level).
func (e *PushOptionEntity) MatchTyped(match ...PushOption) PushOption {
	if len(match) > 0 {
		return typedFrom[PushOption](e.Match(asMap(match[0])))
	}
	return typedFrom[PushOption](e.Match())
}
...
func (e *PushOptionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PushOptionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PushOptionLoadMatch and returns an PushOption. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PushOptionEntity) LoadTyped(reqmatch PushOptionLoadMatch, ctrl map[string]any) (PushOption, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PushOption{}, err
	}
	return typedFrom[PushOption](res), nil
}



func (e *PushOptionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PushOptionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PushOptionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PushOptionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PushOptionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
