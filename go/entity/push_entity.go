...
func NewPushEntity(client *core.CodatplatformSDK, entopts map[string]any) *PushEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PushEntity) GetName() string { return e.name }
...
func (e *PushEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PushEntity) Deleted() bool {
	return e.deleted
}


func (e *PushEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPushEntity(e.client, opts)
}

func (e *PushEntity) Data(args ...any) any {
...
func (e *PushEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Push; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PushEntity) DataTyped(data ...Push) Push {
	if len(data) > 0 {
		return typedFrom[Push](e.Data(asMap(data[0])))
	}
	return typedFrom[Push](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Push (all fields
// optional at the wire level).
func (e *PushEntity) MatchTyped(match ...Push) Push {
	if len(match) > 0 {
		return typedFrom[Push](e.Match(asMap(match[0])))
	}
	return typedFrom[Push](e.Match())
}
...
func (e *PushEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PushEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PushLoadMatch and returns an Push. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PushEntity) LoadTyped(reqmatch PushLoadMatch, ctrl map[string]any) (Push, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Push{}, err
	}
	return typedFrom[Push](res), nil
}




func (e *PushEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PushListMatch and returns []Push. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PushEntity) ListTyped(reqmatch PushListMatch, ctrl map[string]any) ([]Push, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Push](res), nil
}



func (e *PushEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PushEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PushEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PushEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
