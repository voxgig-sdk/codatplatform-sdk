...
func NewSettingEntity(client *core.CodatplatformSDK, entopts map[string]any) *SettingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SettingEntity) GetName() string { return e.name }
...
func (e *SettingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SettingEntity) Deleted() bool {
	return e.deleted
}


func (e *SettingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSettingEntity(e.client, opts)
}

func (e *SettingEntity) Data(args ...any) any {
...
func (e *SettingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Setting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SettingEntity) DataTyped(data ...Setting) Setting {
	if len(data) > 0 {
		return typedFrom[Setting](e.Data(asMap(data[0])))
	}
	return typedFrom[Setting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Setting (all fields
// optional at the wire level).
func (e *SettingEntity) MatchTyped(match ...Setting) Setting {
	if len(match) > 0 {
		return typedFrom[Setting](e.Match(asMap(match[0])))
	}
	return typedFrom[Setting](e.Match())
}
...
func (e *SettingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SettingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SettingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SettingListMatch and returns []Setting. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SettingEntity) ListTyped(reqmatch SettingListMatch, ctrl map[string]any) ([]Setting, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Setting](res), nil
}




func (e *SettingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// SettingCreateData and returns an Setting. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SettingEntity) CreateTyped(reqdata SettingCreateData, ctrl map[string]any) (Setting, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Setting{}, err
	}
	return typedFrom[Setting](res), nil
}



func (e *SettingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *SettingEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// SettingRemoveMatch and returns an Setting. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SettingEntity) RemoveTyped(reqmatch SettingRemoveMatch, ctrl map[string]any) (Setting, error) {
...
func (e *SettingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
