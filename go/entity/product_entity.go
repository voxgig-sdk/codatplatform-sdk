...
func NewProductEntity(client *core.CodatplatformSDK, entopts map[string]any) *ProductEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProductEntity) Deleted() bool {
	return e.deleted
}


func (e *ProductEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProductEntity(e.client, opts)
}

func (e *ProductEntity) Data(args ...any) any {
...
func (e *ProductEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ProductEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *ProductEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProductEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProductEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
