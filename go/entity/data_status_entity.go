...
func NewDataStatusEntity(client *core.CodatplatformSDK, entopts map[string]any) *DataStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataStatusEntity) GetName() string { return e.name }
...
func (e *DataStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *DataStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataStatusEntity(e.client, opts)
}

func (e *DataStatusEntity) Data(args ...any) any {
...
func (e *DataStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataStatusEntity) DataTyped(data ...DataStatus) DataStatus {
	if len(data) > 0 {
		return typedFrom[DataStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[DataStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataStatus (all fields
// optional at the wire level).
func (e *DataStatusEntity) MatchTyped(match ...DataStatus) DataStatus {
	if len(match) > 0 {
		return typedFrom[DataStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[DataStatus](e.Match())
}
...
func (e *DataStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataStatusLoadMatch and returns an DataStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DataStatusEntity) LoadTyped(reqmatch DataStatusLoadMatch, ctrl map[string]any) (DataStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DataStatus{}, err
	}
	return typedFrom[DataStatus](res), nil
}



func (e *DataStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DataStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
