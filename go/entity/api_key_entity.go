...
func NewApiKeyEntity(client *core.CodatplatformSDK, entopts map[string]any) *ApiKeyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiKeyEntity) GetName() string { return e.name }
...
func (e *ApiKeyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiKeyEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiKeyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiKeyEntity(e.client, opts)
}

func (e *ApiKeyEntity) Data(args ...any) any {
...
func (e *ApiKeyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApiKey; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiKeyEntity) DataTyped(data ...ApiKey) ApiKey {
	if len(data) > 0 {
		return typedFrom[ApiKey](e.Data(asMap(data[0])))
	}
	return typedFrom[ApiKey](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApiKey (all fields
// optional at the wire level).
func (e *ApiKeyEntity) MatchTyped(match ...ApiKey) ApiKey {
	if len(match) > 0 {
		return typedFrom[ApiKey](e.Match(asMap(match[0])))
	}
	return typedFrom[ApiKey](e.Match())
}
...
func (e *ApiKeyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiKeyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ApiKeyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ApiKeyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiKeyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ApiKeyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ApiKeyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
