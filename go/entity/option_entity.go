...
func NewOptionEntity(client *core.CodatplatformSDK, entopts map[string]any) *OptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OptionEntity) GetName() string { return e.name }
...
func (e *OptionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OptionEntity) Deleted() bool {
	return e.deleted
}


func (e *OptionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOptionEntity(e.client, opts)
}

func (e *OptionEntity) Data(args ...any) any {
...
func (e *OptionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Option; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OptionEntity) DataTyped(data ...Option) Option {
	if len(data) > 0 {
		return typedFrom[Option](e.Data(asMap(data[0])))
	}
	return typedFrom[Option](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Option (all fields
// optional at the wire level).
func (e *OptionEntity) MatchTyped(match ...Option) Option {
	if len(match) > 0 {
		return typedFrom[Option](e.Match(asMap(match[0])))
	}
	return typedFrom[Option](e.Match())
}
...
func (e *OptionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OptionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OptionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OptionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OptionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OptionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OptionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
