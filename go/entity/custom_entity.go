...
func NewCustomEntity(client *core.CodatplatformSDK, entopts map[string]any) *CustomEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CustomEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *CustomEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
