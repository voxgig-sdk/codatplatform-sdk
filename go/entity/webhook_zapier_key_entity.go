...
type WebhookZapierKeyEntity struct {
	name    string
...
func NewWebhookZapierKeyEntity(client *core.CodatplatformSDK, entopts map[string]any) *WebhookZapierKeyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebhookZapierKeyEntity) GetName() string { return e.name }
...
func (e *WebhookZapierKeyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WebhookZapierKeyEntity) Deleted() bool {
	return e.deleted
}


func (e *WebhookZapierKeyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWebhookZapierKeyEntity(e.client, opts)
}

func (e *WebhookZapierKeyEntity) Data(args ...any) any {
...
func (e *WebhookZapierKeyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WebhookZapierKey; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WebhookZapierKeyEntity) DataTyped(data ...WebhookZapierKey) WebhookZapierKey {
	if len(data) > 0 {
		return typedFrom[WebhookZapierKey](e.Data(asMap(data[0])))
	}
	return typedFrom[WebhookZapierKey](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WebhookZapierKey (all fields
// optional at the wire level).
func (e *WebhookZapierKeyEntity) MatchTyped(match ...WebhookZapierKey) WebhookZapierKey {
	if len(match) > 0 {
		return typedFrom[WebhookZapierKey](e.Match(asMap(match[0])))
	}
	return typedFrom[WebhookZapierKey](e.Match())
}
...
func (e *WebhookZapierKeyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WebhookZapierKeyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *WebhookZapierKeyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *WebhookZapierKeyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WebhookZapierKeyCreateData and returns an WebhookZapierKey. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *WebhookZapierKeyEntity) CreateTyped(reqdata WebhookZapierKeyCreateData, ctrl map[string]any) (WebhookZapierKey, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return WebhookZapierKey{}, err
	}
	return typedFrom[WebhookZapierKey](res), nil
}



func (e *WebhookZapierKeyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WebhookZapierKeyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WebhookZapierKeyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
