...
func NewIntegrationEntity(client *core.CodatplatformSDK, entopts map[string]any) *IntegrationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IntegrationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
