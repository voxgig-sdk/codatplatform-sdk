...
func NewSyncEntity(client *core.CodatplatformSDK, entopts map[string]any) *SyncEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SyncEntity) GetName() string { return e.name }
...
func (e *SyncEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SyncEntity) Deleted() bool {
	return e.deleted
}


func (e *SyncEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSyncEntity(e.client, opts)
}

func (e *SyncEntity) Data(args ...any) any {
...
func (e *SyncEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Sync; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SyncEntity) DataTyped(data ...Sync) Sync {
	if len(data) > 0 {
		return typedFrom[Sync](e.Data(asMap(data[0])))
	}
	return typedFrom[Sync](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Sync (all fields
// optional at the wire level).
func (e *SyncEntity) MatchTyped(match ...Sync) Sync {
	if len(match) > 0 {
		return typedFrom[Sync](e.Match(asMap(match[0])))
	}
	return typedFrom[Sync](e.Match())
}
...
func (e *SyncEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SyncEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SyncEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SyncEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SyncEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SyncEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SyncEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
