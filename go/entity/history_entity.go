...
func NewHistoryEntity(client *core.CodatplatformSDK, entopts map[string]any) *HistoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HistoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HistoryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
