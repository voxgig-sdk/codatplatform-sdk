...
type CompanyAccessTokenEntity struct {
	name    string
...
func NewCompanyAccessTokenEntity(client *core.CodatplatformSDK, entopts map[string]any) *CompanyAccessTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompanyAccessTokenEntity) GetName() string { return e.name }
...
func (e *CompanyAccessTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompanyAccessTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *CompanyAccessTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompanyAccessTokenEntity(e.client, opts)
}

func (e *CompanyAccessTokenEntity) Data(args ...any) any {
...
func (e *CompanyAccessTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CompanyAccessToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompanyAccessTokenEntity) DataTyped(data ...CompanyAccessToken) CompanyAccessToken {
	if len(data) > 0 {
		return typedFrom[CompanyAccessToken](e.Data(asMap(data[0])))
	}
	return typedFrom[CompanyAccessToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CompanyAccessToken (all fields
// optional at the wire level).
func (e *CompanyAccessTokenEntity) MatchTyped(match ...CompanyAccessToken) CompanyAccessToken {
	if len(match) > 0 {
		return typedFrom[CompanyAccessToken](e.Match(asMap(match[0])))
	}
	return typedFrom[CompanyAccessToken](e.Match())
}
...
func (e *CompanyAccessTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompanyAccessTokenEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompanyAccessTokenLoadMatch and returns an CompanyAccessToken. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CompanyAccessTokenEntity) LoadTyped(reqmatch CompanyAccessTokenLoadMatch, ctrl map[string]any) (CompanyAccessToken, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CompanyAccessToken{}, err
	}
	return typedFrom[CompanyAccessToken](res), nil
}



func (e *CompanyAccessTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CompanyAccessTokenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompanyAccessTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompanyAccessTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompanyAccessTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
