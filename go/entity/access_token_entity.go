...
func NewAccessTokenEntity(client *core.CodatplatformSDK, entopts map[string]any) *AccessTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AccessTokenEntity) GetName() string { return e.name }
...
func (e *AccessTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AccessTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *AccessTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAccessTokenEntity(e.client, opts)
}

func (e *AccessTokenEntity) Data(args ...any) any {
...
func (e *AccessTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AccessToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AccessTokenEntity) DataTyped(data ...AccessToken) AccessToken {
	if len(data) > 0 {
		return typedFrom[AccessToken](e.Data(asMap(data[0])))
	}
	return typedFrom[AccessToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AccessToken (all fields
// optional at the wire level).
func (e *AccessTokenEntity) MatchTyped(match ...AccessToken) AccessToken {
	if len(match) > 0 {
		return typedFrom[AccessToken](e.Match(asMap(match[0])))
	}
	return typedFrom[AccessToken](e.Match())
}
...
func (e *AccessTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AccessTokenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AccessTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AccessTokenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AccessTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AccessTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AccessTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
