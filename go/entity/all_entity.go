...
func NewAllEntity(client *core.CodatplatformSDK, entopts map[string]any) *AllEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AllEntity) GetName() string { return e.name }
...
func (e *AllEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AllEntity) Deleted() bool {
	return e.deleted
}


func (e *AllEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAllEntity(e.client, opts)
}

func (e *AllEntity) Data(args ...any) any {
...
func (e *AllEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an All; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AllEntity) DataTyped(data ...All) All {
	if len(data) > 0 {
		return typedFrom[All](e.Data(asMap(data[0])))
	}
	return typedFrom[All](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through All (all fields
// optional at the wire level).
func (e *AllEntity) MatchTyped(match ...All) All {
	if len(match) > 0 {
		return typedFrom[All](e.Match(asMap(match[0])))
	}
	return typedFrom[All](e.Match())
}
...
func (e *AllEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AllEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AllEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AllEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AllEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AllEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AllEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
