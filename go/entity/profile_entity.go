...
func NewProfileEntity(client *core.CodatplatformSDK, entopts map[string]any) *ProfileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProfileEntity) GetName() string { return e.name }
...
func (e *ProfileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProfileEntity) Deleted() bool {
	return e.deleted
}


func (e *ProfileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProfileEntity(e.client, opts)
}

func (e *ProfileEntity) Data(args ...any) any {
...
func (e *ProfileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Profile; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProfileEntity) DataTyped(data ...Profile) Profile {
	if len(data) > 0 {
		return typedFrom[Profile](e.Data(asMap(data[0])))
	}
	return typedFrom[Profile](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Profile (all fields
// optional at the wire level).
func (e *ProfileEntity) MatchTyped(match ...Profile) Profile {
	if len(match) > 0 {
		return typedFrom[Profile](e.Match(asMap(match[0])))
	}
	return typedFrom[Profile](e.Match())
}
...
func (e *ProfileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProfileEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ProfileEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProfileListMatch and returns []Profile. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProfileEntity) ListTyped(reqmatch ProfileListMatch, ctrl map[string]any) ([]Profile, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Profile](res), nil
}



func (e *ProfileEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ProfileEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ProfileUpdateData and returns an Profile. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ProfileEntity) UpdateTyped(reqdata ProfileUpdateData, ctrl map[string]any) (Profile, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Profile{}, err
	}
	return typedFrom[Profile](res), nil
}



func (e *ProfileEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProfileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
