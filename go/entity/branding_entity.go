...
func NewBrandingEntity(client *core.CodatplatformSDK, entopts map[string]any) *BrandingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BrandingEntity) GetName() string { return e.name }
...
func (e *BrandingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BrandingEntity) Deleted() bool {
	return e.deleted
}


func (e *BrandingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBrandingEntity(e.client, opts)
}

func (e *BrandingEntity) Data(args ...any) any {
...
func (e *BrandingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Branding; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BrandingEntity) DataTyped(data ...Branding) Branding {
	if len(data) > 0 {
		return typedFrom[Branding](e.Data(asMap(data[0])))
	}
	return typedFrom[Branding](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Branding (all fields
// optional at the wire level).
func (e *BrandingEntity) MatchTyped(match ...Branding) Branding {
	if len(match) > 0 {
		return typedFrom[Branding](e.Match(asMap(match[0])))
	}
	return typedFrom[Branding](e.Match())
}
...
func (e *BrandingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BrandingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BrandingLoadMatch and returns an Branding. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BrandingEntity) LoadTyped(reqmatch BrandingLoadMatch, ctrl map[string]any) (Branding, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Branding{}, err
	}
	return typedFrom[Branding](res), nil
}



func (e *BrandingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BrandingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BrandingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BrandingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BrandingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
