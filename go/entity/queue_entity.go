...
func NewQueueEntity(client *core.CodatplatformSDK, entopts map[string]any) *QueueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QueueEntity) GetName() string { return e.name }
...
func (e *QueueEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QueueEntity) Deleted() bool {
	return e.deleted
}


func (e *QueueEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQueueEntity(e.client, opts)
}

func (e *QueueEntity) Data(args ...any) any {
...
func (e *QueueEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Queue; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QueueEntity) DataTyped(data ...Queue) Queue {
	if len(data) > 0 {
		return typedFrom[Queue](e.Data(asMap(data[0])))
	}
	return typedFrom[Queue](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Queue (all fields
// optional at the wire level).
func (e *QueueEntity) MatchTyped(match ...Queue) Queue {
	if len(match) > 0 {
		return typedFrom[Queue](e.Match(asMap(match[0])))
	}
	return typedFrom[Queue](e.Match())
}
...
func (e *QueueEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QueueEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *QueueEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *QueueEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QueueEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QueueEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QueueEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
