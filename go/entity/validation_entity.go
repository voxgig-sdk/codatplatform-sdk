...
func NewValidationEntity(client *core.CodatplatformSDK, entopts map[string]any) *ValidationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ValidationEntity) GetName() string { return e.name }
...
func (e *ValidationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ValidationEntity) Deleted() bool {
	return e.deleted
}


func (e *ValidationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewValidationEntity(e.client, opts)
}

func (e *ValidationEntity) Data(args ...any) any {
...
func (e *ValidationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Validation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ValidationEntity) DataTyped(data ...Validation) Validation {
	if len(data) > 0 {
		return typedFrom[Validation](e.Data(asMap(data[0])))
	}
	return typedFrom[Validation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Validation (all fields
// optional at the wire level).
func (e *ValidationEntity) MatchTyped(match ...Validation) Validation {
	if len(match) > 0 {
		return typedFrom[Validation](e.Match(asMap(match[0])))
	}
	return typedFrom[Validation](e.Match())
}
...
func (e *ValidationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ValidationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ValidationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ValidationListMatch and returns []Validation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ValidationEntity) ListTyped(reqmatch ValidationListMatch, ctrl map[string]any) ([]Validation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Validation](res), nil
}



func (e *ValidationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ValidationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ValidationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ValidationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
