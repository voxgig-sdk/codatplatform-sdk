...
func NewRefreshDataEntity(client *core.CodatplatformSDK, entopts map[string]any) *RefreshDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RefreshDataEntity) GetName() string { return e.name }
...
func (e *RefreshDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RefreshDataEntity) Deleted() bool {
	return e.deleted
}


func (e *RefreshDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRefreshDataEntity(e.client, opts)
}

func (e *RefreshDataEntity) Data(args ...any) any {
...
func (e *RefreshDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RefreshData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RefreshDataEntity) DataTyped(data ...RefreshData) RefreshData {
	if len(data) > 0 {
		return typedFrom[RefreshData](e.Data(asMap(data[0])))
	}
	return typedFrom[RefreshData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RefreshData (all fields
// optional at the wire level).
func (e *RefreshDataEntity) MatchTyped(match ...RefreshData) RefreshData {
	if len(match) > 0 {
		return typedFrom[RefreshData](e.Match(asMap(match[0])))
	}
	return typedFrom[RefreshData](e.Match())
}
...
func (e *RefreshDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RefreshDataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RefreshDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RefreshDataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RefreshDataCreateData and returns an RefreshData. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RefreshDataEntity) CreateTyped(reqdata RefreshDataCreateData, ctrl map[string]any) (RefreshData, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return RefreshData{}, err
	}
	return typedFrom[RefreshData](res), nil
}



func (e *RefreshDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RefreshDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RefreshDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
