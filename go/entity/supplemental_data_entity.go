...
type SupplementalDataEntity struct {
	name    string
...
func NewSupplementalDataEntity(client *core.CodatplatformSDK, entopts map[string]any) *SupplementalDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SupplementalDataEntity) GetName() string { return e.name }
...
func (e *SupplementalDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SupplementalDataEntity) Deleted() bool {
	return e.deleted
}


func (e *SupplementalDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSupplementalDataEntity(e.client, opts)
}

func (e *SupplementalDataEntity) Data(args ...any) any {
...
func (e *SupplementalDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SupplementalData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SupplementalDataEntity) DataTyped(data ...SupplementalData) SupplementalData {
	if len(data) > 0 {
		return typedFrom[SupplementalData](e.Data(asMap(data[0])))
	}
	return typedFrom[SupplementalData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SupplementalData (all fields
// optional at the wire level).
func (e *SupplementalDataEntity) MatchTyped(match ...SupplementalData) SupplementalData {
	if len(match) > 0 {
		return typedFrom[SupplementalData](e.Match(asMap(match[0])))
	}
	return typedFrom[SupplementalData](e.Match())
}
...
func (e *SupplementalDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SupplementalDataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SupplementalDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SupplementalDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *SupplementalDataEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SupplementalDataUpdateData and returns an SupplementalData. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *SupplementalDataEntity) UpdateTyped(reqdata SupplementalDataUpdateData, ctrl map[string]any) (SupplementalData, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return SupplementalData{}, err
	}
	return typedFrom[SupplementalData](res), nil
}



func (e *SupplementalDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SupplementalDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
