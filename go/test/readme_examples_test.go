...
const testSeed = `map[string]any{"entity": map[string]any{"access_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "branding": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company_access_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connection_management_access_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connection_management_allowed_origin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "integration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "option": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "profile": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pull_operation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "push": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "push_option": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "queue": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "refresh_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "supplemental_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "supplemental_data_config": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sync": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sync_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "validation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook_zapier_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
