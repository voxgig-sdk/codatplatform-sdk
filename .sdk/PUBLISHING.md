...
|---|---|---|
| `js/` | @voxgig-sdk/codatplatform-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/codatplatform | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/codatplatform-js \
      --repository voxgig-sdk/codatplatform-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/codatplatform-js` shows it, and
`npm trust revoke @voxgig-sdk/codatplatform-js --id=<id>` removes it.
