...
// Codatplatform SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CodatplatformTransformResponse
{
    public static function call(CodatplatformContext $ctx): mixed
    {
        ...
        $transform = CodatplatformHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
