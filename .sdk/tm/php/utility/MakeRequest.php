...
// Codatplatform SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CodatplatformMakeRequest
{
    public static function call(CodatplatformContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CodatplatformResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CodatplatformResponse($fetched);
        } else {
