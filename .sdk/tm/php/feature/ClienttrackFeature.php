...
class CodatplatformClienttrackFeature extends CodatplatformBaseFeature
{
    ...
    public function PostConstruct(CodatplatformContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Codatplatform-SDK';
