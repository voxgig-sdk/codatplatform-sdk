...
// Codatplatform SDK ratelimit feature
...
class CodatplatformRatelimitFeature extends CodatplatformBaseFeature
{
    ...
    private function _acquire(CodatplatformContext $ctx): void
    {
    ...
    private function _track(CodatplatformContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
