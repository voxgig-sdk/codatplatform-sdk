...
// Codatplatform SDK audit feature
...
class CodatplatformAuditFeature extends CodatplatformBaseFeature
{
    ...
    private function _emit(CodatplatformContext $ctx, string $outcome): void
    {
