...
// Codatplatform SDK streaming feature
...
class CodatplatformStreamingFeature extends CodatplatformBaseFeature
{
    ...
    private function _iterate(CodatplatformResult $result): \Generator
    {
    ...
    private function _streamable(CodatplatformContext $ctx): bool
    {
