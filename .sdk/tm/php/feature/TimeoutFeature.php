...
// Codatplatform SDK timeout feature
...
class CodatplatformTimeoutFeature extends CodatplatformBaseFeature
{
    ...
    private function _with_timeout(CodatplatformContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CodatplatformContext $_ctx, float $ms): void
    {
        $client = $this->client;
