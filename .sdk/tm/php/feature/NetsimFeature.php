...
// Codatplatform SDK netsim feature
...
class CodatplatformNetsimFeature extends CodatplatformBaseFeature
{
    ...
    private function _simulate(CodatplatformContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CodatplatformContext $ctx, array $applied): void
    {
        $client = $this->client;
