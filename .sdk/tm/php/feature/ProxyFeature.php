...
// Codatplatform SDK proxy feature
...
class CodatplatformProxyFeature extends CodatplatformBaseFeature
{
    ...
    public function init(CodatplatformContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CodatplatformContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
