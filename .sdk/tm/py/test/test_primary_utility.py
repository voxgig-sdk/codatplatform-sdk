...
from projectname_sdk import CodatplatformSDK
from projectname_sdk.core.spec import CodatplatformSpec
from projectname_sdk.core.result import CodatplatformResult
from projectname_sdk.core.response import CodatplatformResponse
from projectname_sdk.core.operation import CodatplatformOperation
from projectname_sdk.core.error import CodatplatformError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CodatplatformBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CodatplatformError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = CodatplatformSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except CodatplatformError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = CodatplatformResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = CodatplatformSDK.test(None, None)
        ...
        class TestInitFeature(CodatplatformBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CodatplatformBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = CodatplatformSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CodatplatformSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CodatplatformSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = CodatplatformOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CodatplatformSDK.test(None, setup_opts)
