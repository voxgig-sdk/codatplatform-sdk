# Codatplatform SDK clienttrack feature
...
# are never clobbered.
class CodatplatformClienttrackFeature(CodatplatformBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.0.1"
    ...
    def _name(self):
        name = self.options.get("clientName") or "Codatplatform-SDK"
