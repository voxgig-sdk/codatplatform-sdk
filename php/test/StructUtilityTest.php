...
// Codatplatform SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CodatplatformOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CodatplatformOmni::structfix($now, Struct::undef()))
                        !== json_encode(CodatplatformOmni::structfix($val, Struct::undef()))) {
