...
class ProfileDirectTest extends TestCase
{
    public function test_direct_list_profile(): void
    {
        $setup = profile_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-profile", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
