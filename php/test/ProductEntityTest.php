...
class ProductEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CODATPLATFORM_TEST_PRODUCT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function product_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["product01", "product02", "product03", "company01", "company02", "company03"] as $k) {
    ...
    $entid_env_raw = getenv("CODATPLATFORM_TEST_PRODUCT_ENTID");
