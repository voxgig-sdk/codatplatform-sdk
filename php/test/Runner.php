...
class CodatplatformTestRunner
{
    ...
    {
        $live = self::getenv('CODATPLATFORM_TEST_LIVE');
        $override = self::getenv('CODATPLATFORM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CODATPLATFORM_TEST_EXPLAIN');
...
class_alias('CodatplatformTestRunner', 'Runner');
class_alias('CodatplatformHelpers', 'Helpers');
