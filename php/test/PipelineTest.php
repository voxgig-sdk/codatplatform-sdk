...
// Codatplatform SDK pipeline test
//
...
{
    private static function utility(): CodatplatformUtility
    {
        return new CodatplatformUtility();
    }
    ...
    private static function ctx(array $over = []): CodatplatformContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CodatplatformContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CodatplatformOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CodatplatformError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CodatplatformOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CodatplatformMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CodatplatformOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CodatplatformMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CodatplatformOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CodatplatformMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CodatplatformSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CodatplatformMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CodatplatformResponse([]),
            'result' => new CodatplatformResult([]),
        ]);
        [, $err] = CodatplatformMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CodatplatformSpec([]),
            'response' => null,
            'result' => new CodatplatformResult([]),
        ]);
        [, $err] = CodatplatformMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CodatplatformSpec(['step' => 's']),
            'response' => new CodatplatformResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CodatplatformResult([]),
        ]);
        [, $err] = CodatplatformMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CodatplatformSpec(['step' => 's']),
            'response' => new CodatplatformResponse(self::resp(200, ['v' => 1])),
            'result' => new CodatplatformResult([]),
        ]);
        [, $err] = CodatplatformMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CodatplatformSpec(['step' => 's']),
            'response' => new CodatplatformResponse(self::resp(200, ['v' => 2])),
            'result' => new CodatplatformResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CodatplatformMakeResponse::call($ctx);
    ...
    {
        $preset = new CodatplatformResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CodatplatformSpec([]),
            'response' => new CodatplatformResponse([]),
            'result' => new CodatplatformResult([]),
        ...
        [$got, $err] = CodatplatformMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CodatplatformResult([])]);
        [, $err] = CodatplatformMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CodatplatformSpec([]), 'result' => null]);
        [, $err] = CodatplatformMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CodatplatformSpec(['step' => 's']),
            'result' => new CodatplatformResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CodatplatformOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CodatplatformMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CodatplatformSpec(['step' => 's']),
            'result' => new CodatplatformResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CodatplatformOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CodatplatformMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CodatplatformResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CodatplatformSpec([]),
            'result' => new CodatplatformResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CodatplatformMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CodatplatformMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CodatplatformError('boom', 'boom');
        $utility->fetcher = function (CodatplatformContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CodatplatformSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CodatplatformMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CodatplatformContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CodatplatformMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CodatplatformResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CodatplatformMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CodatplatformContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CodatplatformSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CodatplatformMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CodatplatformResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CodatplatformSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CodatplatformMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CodatplatformMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CodatplatformMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CodatplatformResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CodatplatformDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CodatplatformResult(['ok' => false])]);
        $this->expectException(CodatplatformError::class);
        CodatplatformDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CodatplatformResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CodatplatformMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CodatplatformMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CodatplatformBaseFeature();
        $b = new CodatplatformBaseFeature();
        CodatplatformFeatureAdd::call($ctx, $a);
        CodatplatformFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CodatplatformBaseFeature
    {
        $f = new CodatplatformBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CodatplatformFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CodatplatformContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CodatplatformSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CodatplatformPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CodatplatformPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CodatplatformResponse(['headers' => null]),
            'result' => new CodatplatformResult([]),
        ]);
        CodatplatformResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CodatplatformResultBody::call($ctx);
