...
class WebhookEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CODATPLATFORM_TEST_WEBHOOK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function webhook_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CODATPLATFORM_TEST_WEBHOOK_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CODATPLATFORM_TEST_WEBHOOK_ENTID"]);
