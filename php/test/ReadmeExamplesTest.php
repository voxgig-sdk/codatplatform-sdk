...
// Codatplatform SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CodatplatformSDK::test)
...
{
    private const SDK_CLASS = 'CodatplatformSDK';
    ...
    private const SDK_BASE = 'codatplatform_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../codatplatform_sdk.php';
