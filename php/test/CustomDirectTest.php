...
class CustomDirectTest extends TestCase
{
    public function test_direct_load_custom(): void
    {
        $setup = custom_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-custom", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
