...
// Codatplatform SDK cache feature
...
class CodatplatformCacheFeature extends CodatplatformBaseFeature
{
    ...
    private function _through(CodatplatformContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
