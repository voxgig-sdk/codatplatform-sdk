...
// Codatplatform SDK rbac feature
...
class CodatplatformRbacFeature extends CodatplatformBaseFeature
{
    ...
    private function _required(CodatplatformContext $ctx): ?string
    {
    ...
    private function _reject(CodatplatformContext $ctx, string $required): void
    {
    ...
    private function _track(CodatplatformContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
