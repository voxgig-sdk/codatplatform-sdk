...
// Codatplatform SDK paging feature
...
class CodatplatformPagingFeature extends CodatplatformBaseFeature
{
    ...
    private function _graphql_pre_request(CodatplatformContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(CodatplatformContext $ctx): bool
    {
