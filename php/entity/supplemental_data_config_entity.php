...
// Codatplatform SDK SupplementalDataConfig entity
...
class SupplementalDataConfigEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "supplemental_data_config";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SupplementalDataConfigEntity($this->_client, $opts);
    }

    /**
     * @param SupplementalDataConfig|array $args SupplementalDataConfig data (assoc-array) to store.
     */
    ...
    /**
     * @return SupplementalDataConfig|array The current SupplementalDataConfig data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SupplementalDataConfig fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SupplementalDataConfig fields).
     */
    ...
    /**
     * Load a single SupplementalDataConfig.
     *
     * @param SupplementalDataConfigLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SupplementalDataConfigLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SupplementalDataConfig|array The loaded SupplementalDataConfig as an assoc-array at the
