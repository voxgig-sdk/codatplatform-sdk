...
class AccessTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AccessTokenEntity($this->_client, $opts);
    }

    /**
     * @param AccessToken|array $args AccessToken data (assoc-array) to store.
     */
    ...
    /**
     * @return AccessToken|array The current AccessToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccessToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccessToken fields).
     */
