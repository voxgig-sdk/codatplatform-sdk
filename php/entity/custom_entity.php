...
// Codatplatform SDK Custom entity
...
class CustomEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomEntity($this->_client, $opts);
    }

    /**
     * @param Custom|array $args Custom data (assoc-array) to store.
     */
    ...
    /**
     * @return Custom|array The current Custom data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Custom fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Custom fields).
     */
     ...
     *
     * @param CustomLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Custom|array The loaded Custom as an assoc-array at the
     ...
     *
     * @param CustomUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Custom|array The updated Custom as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
