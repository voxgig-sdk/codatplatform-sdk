...
// Codatplatform SDK Connection entity
...
class ConnectionEntity
{
     ...
     *
     * @param ConnectionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConnectionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Connection|array The loaded Connection as an assoc-array at the
     ...
     *
     * @param ConnectionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Connection|array The created Connection as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
     ...
     *
     * @param ConnectionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Connection|array The updated Connection as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Connection matching the given criteria.
     *
     * @param ConnectionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConnectionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Connection|array The removed Connection as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
