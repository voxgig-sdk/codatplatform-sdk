...
// Codatplatform SDK Profile entity
...
class ProfileEntity
{
    ...
    /**
     * List Profile items matching the given filter.
     *
     * @param ProfileListMatch|array|null $reqmatch Match filter (any subset
     *   of Profile fields) as an assoc-array; ProfileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Profile[]|array A list of Profile items as assoc-arrays at
     ...
     *
     * @param ProfileUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProfileUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Profile|array The updated Profile as an assoc-array at the
