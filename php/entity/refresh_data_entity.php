...
// Codatplatform SDK RefreshData entity
...
class RefreshDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RefreshDataEntity($this->_client, $opts);
    }

    /**
     * @param RefreshData|array $args RefreshData data (assoc-array) to store.
     */
    ...
    /**
     * @return RefreshData|array The current RefreshData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RefreshData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RefreshData fields).
     */
    ...
    /**
     * Create a new RefreshData.
     *
     * @param RefreshDataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RefreshDataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RefreshData|array The created RefreshData as an assoc-array at the
