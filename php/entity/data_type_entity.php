...
class DataTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataTypeEntity($this->_client, $opts);
    }

    /**
     * @param DataType|array $args DataType data (assoc-array) to store.
     */
    ...
    /**
     * @return DataType|array The current DataType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataType fields).
     */
