...
// Codatplatform SDK Branding entity
...
class BrandingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BrandingEntity($this->_client, $opts);
    }

    /**
     * @param Branding|array $args Branding data (assoc-array) to store.
     */
    ...
    /**
     * @return Branding|array The current Branding data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Branding fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Branding fields).
     */
    ...
    /**
     * Load a single Branding.
     *
     * @param BrandingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BrandingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Branding|array The loaded Branding as an assoc-array at the
