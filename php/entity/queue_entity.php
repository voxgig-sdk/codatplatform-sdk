...
class QueueEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new QueueEntity($this->_client, $opts);
    }

    /**
     * @param Queue|array $args Queue data (assoc-array) to store.
     */
    ...
    /**
     * @return Queue|array The current Queue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Queue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Queue fields).
     */
