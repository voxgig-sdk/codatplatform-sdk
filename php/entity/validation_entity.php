...
// Codatplatform SDK Validation entity
...
class ValidationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ValidationEntity($this->_client, $opts);
    }

    /**
     * @param Validation|array $args Validation data (assoc-array) to store.
     */
    ...
    /**
     * @return Validation|array The current Validation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Validation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Validation fields).
     */
    ...
    /**
     * List Validation items matching the given filter.
     *
     * @param ValidationListMatch|array|null $reqmatch Match filter (any subset
     *   of Validation fields) as an assoc-array; ValidationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Validation[]|array A list of Validation items as assoc-arrays at
