...
// Codatplatform SDK ConnectionManagementAccessToken entity
...
class ConnectionManagementAccessTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "connection_management_access_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConnectionManagementAccessTokenEntity($this->_client, $opts);
    }

    /**
     * @param ConnectionManagementAccessToken|array $args ConnectionManagementAccessToken data (assoc-array) to store.
     */
    ...
    /**
     * @return ConnectionManagementAccessToken|array The current ConnectionManagementAccessToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectionManagementAccessToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConnectionManagementAccessToken fields).
     */
    ...
    /**
     * Load a single ConnectionManagementAccessToken.
     *
     * @param ConnectionManagementAccessTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConnectionManagementAccessTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectionManagementAccessToken|array The loaded ConnectionManagementAccessToken as an assoc-array at the
