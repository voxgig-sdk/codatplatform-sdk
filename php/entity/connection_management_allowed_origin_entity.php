...
// Codatplatform SDK ConnectionManagementAllowedOrigin entity
...
class ConnectionManagementAllowedOriginEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "connection_management_allowed_origin";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConnectionManagementAllowedOriginEntity($this->_client, $opts);
    }

    /**
     * @param ConnectionManagementAllowedOrigin|array $args ConnectionManagementAllowedOrigin data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = CodatplatformHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return ConnectionManagementAllowedOrigin|array The current ConnectionManagementAllowedOrigin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectionManagementAllowedOrigin fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = CodatplatformHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of ConnectionManagementAllowedOrigin fields).
     */
    ...
    /**
     * List ConnectionManagementAllowedOrigin items matching the given filter.
     *
     * @param ConnectionManagementAllowedOriginListMatch|array|null $reqmatch Match filter (any subset
     *   of ConnectionManagementAllowedOrigin fields) as an assoc-array; ConnectionManagementAllowedOriginListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectionManagementAllowedOrigin[]|array A list of ConnectionManagementAllowedOrigin items as assoc-arrays at
     *   the SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new ConnectionManagementAllowedOrigin.
     *
     * @param ConnectionManagementAllowedOriginCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectionManagementAllowedOriginCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectionManagementAllowedOrigin|array The created ConnectionManagementAllowedOrigin as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                if ($ctx->result->resdata) {
                    $this->_data = CodatplatformHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
