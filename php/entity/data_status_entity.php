...
// Codatplatform SDK DataStatus entity
...
class DataStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataStatusEntity($this->_client, $opts);
    }

    /**
     * @param DataStatus|array $args DataStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return DataStatus|array The current DataStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataStatus fields).
     */
    ...
    /**
     * Load a single DataStatus.
     *
     * @param DataStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DataStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataStatus|array The loaded DataStatus as an assoc-array at the
