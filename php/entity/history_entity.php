...
class HistoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HistoryEntity($this->_client, $opts);
    }

    /**
     * @param History|array $args History data (assoc-array) to store.
     */
    ...
    /**
     * @return History|array The current History data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of History fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of History fields).
     */
