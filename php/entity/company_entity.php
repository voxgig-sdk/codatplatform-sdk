...
// Codatplatform SDK Company entity
...
class CompanyEntity
{
     ...
     *
     * @param CompanyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CompanyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Company|array The created Company as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
     ...
     *
     * @param CompanyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CompanyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Company|array The updated Company as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Company matching the given criteria.
     *
     * @param CompanyRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CompanyRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Company|array The removed Company as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
