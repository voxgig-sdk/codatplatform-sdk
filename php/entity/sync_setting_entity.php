...
// Codatplatform SDK SyncSetting entity
...
class SyncSettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SyncSettingEntity($this->_client, $opts);
    }

    /**
     * @param SyncSetting|array $args SyncSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return SyncSetting|array The current SyncSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SyncSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SyncSetting fields).
     */
    ...
    /**
     * List SyncSetting items matching the given filter.
     *
     * @param SyncSettingListMatch|array|null $reqmatch Match filter (any subset
     *   of SyncSetting fields) as an assoc-array; SyncSettingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SyncSetting[]|array A list of SyncSetting items as assoc-arrays at
