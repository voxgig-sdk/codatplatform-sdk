...
class SyncEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SyncEntity($this->_client, $opts);
    }

    /**
     * @param Sync|array $args Sync data (assoc-array) to store.
     */
    ...
    /**
     * @return Sync|array The current Sync data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sync fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sync fields).
     */
