...
// Codatplatform SDK PushOption entity
...
class PushOptionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PushOptionEntity($this->_client, $opts);
    }

    /**
     * @param PushOption|array $args PushOption data (assoc-array) to store.
     */
    ...
    /**
     * @return PushOption|array The current PushOption data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PushOption fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PushOption fields).
     */
    ...
    /**
     * Load a single PushOption.
     *
     * @param PushOptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PushOptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PushOption|array The loaded PushOption as an assoc-array at the
