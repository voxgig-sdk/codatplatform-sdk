...
class PushEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PushEntity($this->_client, $opts);
    }

    /**
     * @param Push|array $args Push data (assoc-array) to store.
     */
    ...
    /**
     * @return Push|array The current Push data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Push fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Push fields).
     */
     ...
     * Load a single Push.
     *
     * @param PushLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PushLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Push|array The loaded Push as an assoc-array at the
    ...
    /**
     * List Push items matching the given filter.
     *
     * @param PushListMatch|array|null $reqmatch Match filter (any subset
     *   of Push fields) as an assoc-array; PushListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Push[]|array A list of Push items as assoc-arrays at
