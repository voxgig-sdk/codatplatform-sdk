...
// Codatplatform SDK WebhookZapierKey entity
...
class WebhookZapierKeyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebhookZapierKeyEntity($this->_client, $opts);
    }

    /**
     * @param WebhookZapierKey|array $args WebhookZapierKey data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhookZapierKey|array The current WebhookZapierKey data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhookZapierKey fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhookZapierKey fields).
     */
    ...
    /**
     * Create a new WebhookZapierKey.
     *
     * @param WebhookZapierKeyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhookZapierKeyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhookZapierKey|array The created WebhookZapierKey as an assoc-array at the
