...
// Codatplatform SDK PullOperation entity
...
class PullOperationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PullOperationEntity($this->_client, $opts);
    }

    /**
     * @param PullOperation|array $args PullOperation data (assoc-array) to store.
     */
    ...
    /**
     * @return PullOperation|array The current PullOperation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PullOperation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PullOperation fields).
     */
    ...
    /**
     * Load a single PullOperation.
     *
     * @param PullOperationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PullOperationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullOperation|array The loaded PullOperation as an assoc-array at the
    ...
    /**
     * List PullOperation items matching the given filter.
     *
     * @param PullOperationListMatch|array|null $reqmatch Match filter (any subset
     *   of PullOperation fields) as an assoc-array; PullOperationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullOperation[]|array A list of PullOperation items as assoc-arrays at
    ...
    /**
     * Create a new PullOperation.
     *
     * @param PullOperationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PullOperationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PullOperation|array The created PullOperation as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
