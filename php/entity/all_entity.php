...
class AllEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AllEntity($this->_client, $opts);
    }

    /**
     * @param All|array $args All data (assoc-array) to store.
     */
    ...
    /**
     * @return All|array The current All data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of All fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of All fields).
     */
