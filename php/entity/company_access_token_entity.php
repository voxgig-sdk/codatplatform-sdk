...
// Codatplatform SDK CompanyAccessToken entity
...
class CompanyAccessTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "company_access_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CompanyAccessTokenEntity($this->_client, $opts);
    }

    /**
     * @param CompanyAccessToken|array $args CompanyAccessToken data (assoc-array) to store.
     */
    ...
    /**
     * @return CompanyAccessToken|array The current CompanyAccessToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CompanyAccessToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CompanyAccessToken fields).
     */
    ...
    /**
     * Load a single CompanyAccessToken.
     *
     * @param CompanyAccessTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CompanyAccessTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompanyAccessToken|array The loaded CompanyAccessToken as an assoc-array at the
