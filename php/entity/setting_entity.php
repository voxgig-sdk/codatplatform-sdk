...
// Codatplatform SDK Setting entity
...
class SettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SettingEntity($this->_client, $opts);
    }

    /**
     * @param Setting|array $args Setting data (assoc-array) to store.
     */
    ...
    /**
     * @return Setting|array The current Setting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Setting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Setting fields).
     */
    ...
    /**
     * List Setting items matching the given filter.
     *
     * @param SettingListMatch|array|null $reqmatch Match filter (any subset
     *   of Setting fields) as an assoc-array; SettingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Setting[]|array A list of Setting items as assoc-arrays at
     ...
     *
     * @param SettingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SettingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Setting|array The created Setting as an assoc-array at the
    ...
    /**
     * Remove an Setting matching the given criteria.
     *
     * @param SettingRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SettingRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Setting|array The removed Setting as an assoc-array at the
     *   SDK boundary; throws CodatplatformError on failure (item-5 convention).
     */
