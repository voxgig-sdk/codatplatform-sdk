...
// Codatplatform SDK SupplementalData entity
...
class SupplementalDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SupplementalDataEntity($this->_client, $opts);
    }

    /**
     * @param SupplementalData|array $args SupplementalData data (assoc-array) to store.
     */
    ...
    /**
     * @return SupplementalData|array The current SupplementalData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SupplementalData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SupplementalData fields).
     */
    ...
    /**
     * Update an existing SupplementalData.
     *
     * @param SupplementalDataUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SupplementalDataUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SupplementalData|array The updated SupplementalData as an assoc-array at the
