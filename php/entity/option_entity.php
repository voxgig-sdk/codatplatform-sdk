...
class OptionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OptionEntity($this->_client, $opts);
    }

    /**
     * @param Option|array $args Option data (assoc-array) to store.
     */
    ...
    /**
     * @return Option|array The current Option data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Option fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Option fields).
     */
