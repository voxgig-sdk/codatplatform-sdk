...
// Codatplatform SDK utility: fetcher

class CodatplatformFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CodatplatformSDK/1.0)';
    ...
    public static function call(CodatplatformContext $ctx, string $fullurl, array $fetchdef): array
    {
