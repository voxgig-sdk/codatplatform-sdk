...
// Codatplatform SDK utility: graphql
//
...
class CodatplatformGraphql
{
    ...
    // equivalent.
    public static function body(CodatplatformContext $ctx): mixed
    {
    ...
    public static function errors(CodatplatformContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
