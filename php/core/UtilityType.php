...
// Codatplatform SDK utility type

class CodatplatformUtility
{
    ...
    public static function copy(CodatplatformUtility $src): CodatplatformUtility
    {
        $u = new CodatplatformUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
